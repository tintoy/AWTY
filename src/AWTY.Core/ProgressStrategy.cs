    ...
    public static partial class ProgressStrategy
    {
        ...
        public static class PercentComplete
        {
            ...
            public static class Chunked
            {
                ...
                /// </returns>
                public static IProgressStrategy<int> Int32(int chunkSize) => new Int32ChunkedPercentageStrategy(chunkSize);
                ...
                ///     The new <see cref="IProgressStrategy{TValue}"/>.
                /// </returns>
                public static IProgressStrategy<long> Int64(int chunkSize) => new Int64ChunkedPercentageStrategy(chunkSize);
            }
        }
    }
}